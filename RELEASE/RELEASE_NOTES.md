# Release Notes - Terraform Provider Harvester

## Version: v0.7.0 (à définir)
...
## 📋 Checklist pour la release

- [ ] Vérifier que tous les tests passent
- [ ] Vérifier que la documentation est à jour
- [ ] Créer un tag Git : `git tag -a v0.7.0 -m "Release v0.7.0"`
- [ ] Pousser le tag : `git push origin v0.7.0`
- [ ] Créer la release sur GitHub avec ces notes
- [ ] Attacher les binaires si nécessaire
